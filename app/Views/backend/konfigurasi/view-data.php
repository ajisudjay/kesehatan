    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('konfigurasi/tambah'); ?>" method="post" class="tambah">
                    <?php csrf_field() ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                            ...
                            <div class="col-lg-12">
                                ...
                                <textarea name="isi" class="form-control isi" cols="30" rows="10"></textarea>
                                <br>
                            </div>
                            <div class="col-lg-12">
    ...
    <table id="scr-vtr-dynamic" class="table table-striped table-bordered nowrap">
        <thead>
            <tr>
                ...
                <th style="max-width:10%;">Urutan</th>
                <th style="max-width:25%;">Konfigurasi</th>
                <th style="width:10px;">Isi</th>
            </tr>
        </thead>
        <tbody>
            <?php $no = 1 ?>
            ...
            <?php foreach ($konfigurasi as $item) : ?>
                ...
                <tr style="text-align:center;">
                    ...
                    <td>
                        ...
                        <!-- button hapus modal-->
                        <a href="<?= base_url('konfigurasi/hapus/' . $item['id']); ?>" class="hapus">
                    ...
                    <td style="height:75px;text-align:left;">
                        <pre style="font-family:Calibri ;"><?= $item['isi'] ?></pre>
                    </td>
                </tr>
            <?php endforeach ?>
        </tbody>
