...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Jan 2023 pada 01.34
...
INSERT INTO `pertanyaan` (`nomor`, `pertanyaan`) VALUES
...
--
ALTER TABLE `koresponden`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1575742479;
COMMIT;
